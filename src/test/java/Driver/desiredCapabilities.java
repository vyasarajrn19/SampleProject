...
//    		driver =  new AndroidDriver<MobileElement>(server.getUrl(), capabilities);
    		...
    		PageFactory.initElements(driver, Amazon_HamburgerMenuTest.class);
    		PageFactory.initElements(driver, Amazon_HomePageTest.class);
    		PageFactory.initElements(driver, Amazon_LoginPageTest.class);
    		PageFactory.initElements(driver, Amazon_SearchResultPageTest.class);
